...
const Map<String, String> arStrings = {
  ...
  'events_filter_events_by_city': 'تصفية الفعاليات حسب المدينة',
  'events_filter_by_city': 'تصفية حسب المدينة',
  ...
  'events_filter_by_city_step': 'تصفية حسب المدينة',
  'events_filter_by_city_step_body': 'في قسم الفعاليات، انقر على "تصفية حسب المدينة" لتضييق نطاق الفعاليات إلى وجهة معينة.',
