...
const Map<String, String> ckbStrings = {
  ...
  'live_now': 'ئێستا ڕاستەوخۆیە',
  'join_live': 'بەشداریکردن',
  'end_live': 'کۆتاییهێنان بە ڕاستەوخۆ',
  'viewers': 'بینەران',
  'no_live_streams': 'هیچ پەخشێکی ڕاستەوخۆ نییە لە ئێستادا',
  'viewers_count': '{count} بینەر',
  ...
  'feature_live_streaming': 'پەخشی ڕاستەوخۆ',
  'live_list_unavailable': 'لیستی ڕاستەوخۆکان بەردەست نییە',
  'live_no_one_live': 'هیچ کەسێک لایڤ نییە لە ئێستادا',
  'live_host_prefix': 'پێشکەشکار: {host}',
  'live_add_title_hint': 'ناونیشانێک زیاد بکە...',
  'live_title_helper': 'فۆڵۆوەرەکانت و هەر کەسێک کە سەیری دەکات ئەم ناونیشانە دەبینێت.',
  'live_go_live_button': 'دەستپێکردنی ڕاستەوخۆ',
  'live_permissions_required': 'مۆڵەتەکانی کامێرا و مایک پێویستن بۆ پەخشی ڕاستەوخۆ.',
  'live_unavailable_spark': 'پەخشی ڕاستەوخۆ لە دۆخی Spark بەردەست نییە. خزمەتگوزاری کۆدی دەرەکی Agora ڕێکبخە بۆ چالاککردنی.',
  'live_agora_error': 'هەڵەی Agora: {error}',
  'live_unable_to_start': 'نەتوانرا پەخشی ڕاستەوخۆ دەستپێبکات',
  'live_unable_to_start_stream': 'نەتوانرا پەخش دەستپێبکات',
  'live_end_button': 'کۆتاییهێنان',
  'live_unable_to_join': 'نەتوانرا بەشداری پەخش بکرێت',
  'live_waiting_host_video': 'چاوەڕوانی ڤیدیۆی پێشکەشکار…',
  'live_label_short': 'ڕاستەوخۆ',
  ...
  'admin_flag_live': 'پەخشی ڕاستەوخۆ چالاککراوە',
